...
MEDIAN_FIELDS = (
    ...
    "component_bag_hits",
    "component_bag_local_hits",
    "component_bag_inserts",
    "component_bag_local_duplicate_inserts",
    "component_bag_shared_queries",
    "component_bag_shared_hits",
    "component_bag_persistent_hits",
    "component_bag_shared_inserts",
    ...
    "component_native_calls",
    "component_native_eligible",
    "component_native_solved",
    "component_native_states",
    "component_native_memo_hits",
    "component_native_transition_queries",
    "component_native_transition_hits",
    "component_native_transition_builds",
    "component_native_transition_options",
    "component_native_transition_deduplicated",
    "component_native_value_option_queries",
    "component_native_value_option_hits",
    "component_native_closure_fallbacks",
    "component_native_cancellations",
    "scheduler_subtasks_generated",
    "scheduler_subtasks_released",
    "scheduler_subtasks_never_released",
    "scheduler_abandoned_published",
    "scheduler_stale_queued",
    "scheduler_stale_results",
    "scheduler_no_work_polls",
    "scheduler_ready_high_water",
    "component_bag_db_loaded_signatures",
    "component_bag_db_loaded_bags",
    "component_bag_db_load_seconds",
